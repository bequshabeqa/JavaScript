function searchContact() {
    let input, filter, p, a, i, txtValue; // რამოდენიმე ცვალი შევქმენით ერთდროულად, რომლებსაც ქვევით კოდში გამოვიყენებთ, ჯერჯერობით მათი მნიშვნელობები არ მიგვითითებია რადგან ეს ქვევით უნდა მოხდეს
